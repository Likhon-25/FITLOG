...
const Banner = () => {
  return (
    <section className="w-full px-5 md:px-10 py-10">
      <div className="mx-auto w-full max-w-[1730px] min-h-[475px] bg-[#15171D]  rounded-none px-8 md:px-12 lg:px-12 flex flex-col md:flex-row items-center justify-between overflow-hidden">

        {/* Content */}
        <div className="w-full md:max-w-[520px] py-10 md:py-0">
